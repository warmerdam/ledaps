...
utm_zone = int(srs[-2:])
ul_x = full_gt[0] + srcwin[0] * full_gt[1]
ul_y = full_gt[3] + srcwin[1] * full_gt[5]
pixel_size = full_gt[1]

# TODO(warmerdam): make parametric
aerosol_geotransform = (579285, 1200, 0,
                        3435015, 0, -1200)
