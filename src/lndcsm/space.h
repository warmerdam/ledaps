...
typedef struct {
  Img_coord_int_t img_size;  /* Image size (lines, samples) */
  Geo_coord_t ul_corner;      /* north west ( upper left ) geo image corner */
  Geo_coord_t lr_corner;      /* south east ( lower right) geo image corner */
  double geo_pixel_size_x;    /* geo pixel size x */
  double geo_pixel_size_y;    /* geo pixel size x */
} Geo_def_t;
